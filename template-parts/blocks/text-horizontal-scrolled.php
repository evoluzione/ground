...
if ( $title ) : ?>
	<div
		class="relative ground-block <?php echo $no_margin ? '' : 'my-12 lg:my-24'; ?> <?php echo esc_attr( ground_block_class( $block ) ); ?>">
			...
			<?php if ( $button ) { ?>
				...
				<?php if ( $image ) { ?>
					...
					if ( $image_square ) {
						...
						?>
							src="<?php echo GROUND_TEMPLATE_URL; ?>/img/placeholder.svg" <?php } ?> alt="" loading="lazy">
				<?php } ?>
				...
				<div class="lg:flex lg:items-center lg:justify-between">
					<?php if ( $button ) { ?>
						...
						<div class="text-center py-6">
							<?php if ( $title ) : ?>
								<h2 data-scroll="js-parallax" data-scroll-speed-y="0" data-scroll-speed-x="8"
									class="whitespace-nowrap text-tertiary text-9xl w-full"><?php echo esc_attr( $title ); ?>
								</h2>
							<?php endif; ?>
						</div>
						<?php if ( $button ) { ?>

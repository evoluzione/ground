	...
	<div class="container">
		<div class="grid grid-cols-2 lg:grid-cols-4 gap-6">
			...
			<?php if ( is_active_sidebar( 'sidebar-footer-primary' ) ) : ?>
				<div class="mb-12">
					<?php get_template_part( 'template-parts/sidebar/sidebar-footer-primary' ); ?>
				</div>
			<?php endif; ?>

			<?php if ( is_active_sidebar( 'sidebar-footer-secondary' ) ) : ?>
				<div class="mb-12">
					<?php get_template_part( 'template-parts/sidebar/sidebar-footer-secondary' ); ?>
				</div>
			<?php endif; ?>

			<?php if ( is_active_sidebar( 'sidebar-footer-tertiary' ) ) : ?>
				<div class="mb-12">
					<?php get_template_part( 'template-parts/sidebar/sidebar-footer-tertiary' ); ?>
				</div>
			<?php endif; ?>
	...
	<div class="container">
		<div class="mt-6 py-9 border-t border-septenary lg:flex lg:items-center lg:justify-between lg:space-x-9 lg:pt-9">
			...
			<div class="lg:border-l border-septenary">
				<?php get_template_part( 'template-parts/shared/socials' ); ?>
			</div>
		</div>

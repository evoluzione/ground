...
if (!defined('GROUND_CHILD_TEMPLATE_URL')) {
	define('GROUND_CHILD_TEMPLATE_URL', get_stylesheet_directory_uri()); // Return http://www.site.com/wp-content/themes/themechildname.
}
...
if (!defined('GROUND_CHILD_TEMPLATE_PATH')) {
	define('GROUND_CHILD_TEMPLATE_PATH', get_stylesheet_directory()); // Return /home/user/public_html/wp-content/themes/themename.
}
...
function ground_theme_costants()
{
	...
	// if (!defined('GROUND_COLOR_HEADER')) {
	// define('GROUND_COLOR_HEADER', get_theme_mod('color_header') ?: GROUND_COLOR_SEPTENARY);
	// }
	...
	if (!defined('GROUND_SHOP_ENABLE_GUTEMBERG_EDITOR')) {
		define('GROUND_SHOP_ENABLE_GUTEMBERG_EDITOR', get_theme_mod('shop_enable_gutemberg_editor') ? get_theme_mod('shop_enable_gutemberg_editor') : '');
	}

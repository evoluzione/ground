...
function ground_customizer_colors($wp_customize)
{
    ...
    $wp_customize->add_panel(
        ...
        array(
            ...
            'description' => __('Set the site color', 'ground-admin'),
        )
    );
...
function ground_section_colors_header($wp_customize, $panel_name)
{
    ...
    $wp_customize->add_section(
        ...
        array(
            ...
            'panel' => $panel_name,
            'description' => __('Set the header site color', 'ground-admin'),
        )
    );
    ...
    $color_list[] = array(
        ...
        'label'       => __('Color header', 'ground-admin'),
    );
...
function ground_section_colors_footer($wp_customize, $panel_name)
{
    ...
    $wp_customize->add_section(
        ...
        array(
            ...
            'panel' => $panel_name,
            'description' => __('Set the footer site color', 'ground-admin'),
        )
    );

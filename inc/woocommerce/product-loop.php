...
function ground_archive_filters_buttons() {
	...
	<div class="sticky top-16 bg-body border-b border-typo border-opacity-theme z-20 transform -translate-x-2/4 w-screen ml-1/2 lg:relative lg:bg-transparent lg:ml-auto lg:translate-x-0 lg:w-auto lg:border-0 lg:top-0">

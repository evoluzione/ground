...
function ground_general_product_data_custom_fields() {
	...
	woocommerce_wp_checkbox(
		array(
			...
			'description'   => __( 'This product is not purchasable <a target="_blank" href="' . esc_url( home_url( '/wp-admin/admin.php?page=acf-options-shop' ) ) . '">Set up global messages for Not Purchasable products</a>', 'ground-admin' ),
		)
	);
}

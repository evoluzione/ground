<form id="js-ajax-search" class="form search__form relative <?php echo GROUND_HEADER_TYPE == 'megaMenu' ? 'container' : ''; ?> <?php echo ( GROUND_HEADER_ADVICE || GROUND_COMPANY_PHONE || GROUND_COMPANY_WHATSAPP ) ? '' : 'mt-2 lg:mt-0'; ?>" method="get" action="<?php echo home_url( '/' ); ?>">

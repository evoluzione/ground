...
if ( $repeater ) : ?>
	...
	<div
		class="relative ground-block overflow-hidden is-fullscreen <?php echo $no_margin ? '' : 'my-12 lg:my-24'; ?> not-prose <?php echo esc_attr( ground_block_class( $block ) ); ?>">
		<div class="container">
			...
			<div class="carousel carousel--primary swiper-container js-slider js-carousel" data-scroll="js-slider-autoplay">
					...
					foreach ( $repeater as $row ) :
						...
						<div class="carousel__item swiper-slide">
							<div class="aspect-w-1 aspect-h-1 lg:aspect-w-16 lg:aspect-h-9 rounded-media">
								<?php if ( $image ) { ?>
									<figure
										class="carousel__media overflow-hidden aspect-w-1 aspect-h-1 lg:aspect-w-16 lg:aspect-h-9 rounded-media">
							...
							<div class="carousel__body">
								...
								<?php if ( $button ) : ?>
									<div class="carousel__button">
										<a class="button"
											href="<?php echo esc_attr( $button['url'] ); ?>"><?php echo esc_attr( $button['title'] ); ?></a>
									</div>
								<?php endif; ?>
							</div>
						</div>
				...
				<div class="carousel__navigation-container">
					<div
						class="carousel__navigation carousel__navigation--prev swiper-button-prev js-slider-primary-navigation-prev js-cursor-left js-magnet">
						<?php ground_icon( [ 
							'name' => 'arrow-left',
						] ); ?>
					</div>
					<div
						class="carousel__pagination carousel__pagination--flat swiper-pagination js-slider-primary-pagination">
					</div>
					<div
						class="carousel__navigation carousel__navigation--next swiper-button-next js-slider-primary-navigation-next js-cursor-right js-magnet">
						<?php ground_icon( [ 
							'name' => 'arrow-right',
						] ); ?>
					</div>

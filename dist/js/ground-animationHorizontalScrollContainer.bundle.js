"use strict";
(self["webpackChunkground"] = self["webpackChunkground"] || []).push([["ground-animationHorizontalScrollContainer"],{
...
/***/ "./js/animations/animationHorizontalScrollContainer.js":
/*!*************************************************************!*\
  !*** ./js/animations/animationHorizontalScrollContainer.js ***!
  \*************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": function() { return /* binding */ AnimationHorizontalScrollContainer; }
/* harmony export */ });
...
var AnimationHorizontalScrollContainer = /*#__PURE__*/function (_AnimationDefault) {
  _inherits(AnimationHorizontalScrollContainer, _AnimationDefault);

  var _super = _createSuper(AnimationHorizontalScrollContainer);

  function AnimationHorizontalScrollContainer(element, options) {
    var _this;

    _classCallCheck(this, AnimationHorizontalScrollContainer);

    _this = _super.call(this, element, options);
    _this.element = element || '[data-scroll="js-horizontal-scroll-container"]';
    return _this;
  }

  _createClass(AnimationHorizontalScrollContainer, [{
    key: "fireAnimation",
    value: function fireAnimation(item) {
      var target = item.querySelector('[data-scroll-target]');
      var panel = item.querySelectorAll('[data-scroll-panel]');
      var targetScrub = item.dataset.scrollScrub; // console.log(targetScrub);

      var sections = gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.utils.toArray(panel);
      var scrollTween = gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.to(sections, {
      ...
      gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.to('.js-box-1', {
        y: -130,
        duration: 2,
        ease: 'elastic',
        scrollTrigger: {
      ...
      gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.to('.js-box-2', {
        y: 320,
        backgroundColor: 'red',
        ease: 'none',
        scrollTrigger: {
  ...
  return AnimationHorizontalScrollContainer;
...
//# sourceMappingURL=ground-animationHorizontalScrollContainer.bundle.js.map
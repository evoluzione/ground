"use strict";
(self["webpackChunkground"] = self["webpackChunkground"] || []).push([["ground-animationScale"],{
...
/***/ "./js/animations/animationScale.js":
/*!*****************************************!*\
  !*** ./js/animations/animationScale.js ***!
  \*****************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": function() { return /* binding */ AnimationScale; }
/* harmony export */ });
...
var AnimationScale = /*#__PURE__*/function (_AnimationDefault) {
  _inherits(AnimationScale, _AnimationDefault);

  var _super = _createSuper(AnimationScale);

  /**
   * @param {string} element - Selector
   * @param {Object} options - User options
   */
  function AnimationScale(element, options) {
    var _this;

    _classCallCheck(this, AnimationScale);

    _this = _super.call(this, element, options);
    _this.element = element || '[data-scroll="js-scale"]';
    return _this;
  }

  _createClass(AnimationScale, [{
    key: "fireAnimation",
    value: function fireAnimation(item) {
...
//# sourceMappingURL=ground-animationScale.bundle.js.map
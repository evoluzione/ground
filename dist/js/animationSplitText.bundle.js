...
gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.registerPlugin(gsap_all__WEBPACK_IMPORTED_MODULE_3__.ScrollTrigger, gsap_all__WEBPACK_IMPORTED_MODULE_4__.SplitText);

var AnimationSplitText = /*#__PURE__*/function () {
  /**
  ...
  _createClass(AnimationSplitText, [{
    ...
    value: function updateEvents(target) {
      ...
      setTimeout(function () {
        if (element.dataset.scroll === 'js-split-text') {
          _this2.animationSplitText(element);
        } else {

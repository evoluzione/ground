"use strict";
(self["webpackChunkground"] = self["webpackChunkground"] || []).push([["ground-animationBatch"],{
...
var AnimationBatch = /*#__PURE__*/function (_AnimationDefault) {
  _inherits(AnimationBatch, _AnimationDefault);

  var _super = _createSuper(AnimationBatch);
  ...
  function AnimationBatch(element, options) {
    ...
    _this.element = element || '[data-scroll="js-batch"]';
    return _this;
  }
  ...
  _createClass(AnimationBatch, [{
    ...
    value: function fireAnimation(item) {
      ...
      gsap_all__WEBPACK_IMPORTED_MODULE_2__.ScrollTrigger.batch(target, {
        interval: 0.3,
        // time window (in seconds) for batching to occur.
        batchMax: 3,
        // maximum batch size (targets)
        onEnter: function onEnter(batch) {
          return gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.to(batch, {
            autoAlpha: 1,
            stagger: 0.1,
            overwrite: true
          });
        ...
        onLeave: function onLeave(batch) {
          return gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.set(batch, {
            autoAlpha: 0,
            overwrite: true
          });
        },
...
//# sourceMappingURL=ground-animationBatch.bundle.js.map
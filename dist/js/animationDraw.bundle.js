"use strict";
(self["webpackChunkground"] = self["webpackChunkground"] || []).push([["animationDraw"],{
...
/***/ "./js/animations/animationDraw.js":
/*!****************************************!*\
  !*** ./js/animations/animationDraw.js ***!
  \****************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": function() { return /* binding */ AnimationDraw; }
/* harmony export */ });
...
gsap__WEBPACK_IMPORTED_MODULE_1__.gsap.registerPlugin(gsap_all__WEBPACK_IMPORTED_MODULE_2__.ScrollTrigger, gsap_all__WEBPACK_IMPORTED_MODULE_3__.DrawSVGPlugin);

var AnimationDraw = /*#__PURE__*/function (_AnimationDefault) {
  _inherits(AnimationDraw, _AnimationDefault);

  var _super = _createSuper(AnimationDraw);

  function AnimationDraw(element, options) {
    var _this;

    _classCallCheck(this, AnimationDraw);

    _this = _super.call(this, element, options);
    _this.element = element || '[data-scroll="js-draw"]';
    return _this;
  }
...
//# sourceMappingURL=animationDraw.bundle.js.map